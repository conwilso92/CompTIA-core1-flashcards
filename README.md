...
A browser-based flashcard app designed for studying the CompTIA A+ Core 1 certification exam. 164 cards covering all 6 exam domains: Mobile Devices, Networking, Hardware, Printers & Peripherals, Cloud & Virtualization, and Troubleshooting.
How to use:
